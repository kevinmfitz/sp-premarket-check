# S&P (ES/MES) Pre-Market Conditions — 2026-09-16

_Generated 9/16/2026, 1:06:58 PM ET · data as of last Yahoo Finance print, informational only, not a trade signal._
...
- High-impact release(s) today (FOMC Rate Decision + SEP/Dot Plot) — expect sharper, noisier moves; often the catalyst for the opening sweep, not a reason to skip.
...
|---|---|---|
| Current (ES) | 7680.75 | — |
| Previous Day High (PDH) | 7687.00 | -6.25 |
| Previous Day Low (PDL) | 7643.50 | 37.25 |
| Overnight High (ONH) | 7689.25 | -8.50 |
| Overnight Low (ONL) | 7658.75 | 22.00 |

## Level Confluence

Levels within 9 pts of each other (stronger, higher-conviction zones):

- **PDH & ONH** are only 2.25 pts apart — a cluster worth weighting more.

## Overnight Range

Overnight range: **30.50 pts** vs. 20-session average of **59.61 pts** → **Tight**.
_Tight range = levels are bunched close together; watch for lower-quality/choppy sweeps._

## Gap

Current price is **+24.00 pts** vs. previous RTH close (7656.75).
- Price is currently inside all four levels (no level broken pre-market).

## Economic Calendar Today

- **14:00 ET** — FOMC Rate Decision + SEP/Dot Plot (high impact)
- **08:30 ET** — Retail Sales (medium impact)

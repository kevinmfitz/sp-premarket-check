...
_Generated 9/4/2026, 12:27:57 PM ET · data as of last Yahoo Finance print, informational only, not a trade signal._
...
- Pre-market: Trading BELOW Overnight Low (7731.25) — that level's sweep/break may already be in motion before the open.
...
|---|---|---|
| Current (ES) | 7729.25 | — |
| Previous Day High (PDH) | 7766.50 | -37.25 |
| Previous Day Low (PDL) | 7700.00 | 29.25 |
| Overnight High (ONH) | 7764.50 | -35.25 |
| Overnight Low (ONL) | 7731.25 | -2.00 |

## Level Confluence

Levels within 8 pts of each other (stronger, higher-conviction zones):

- **PDH & ONH** are only 2 pts apart — a cluster worth weighting more.

## Overnight Range

Overnight range: **33.25 pts** vs. 20-session average of **52.77 pts** → **Normal**.

## Gap

Current price is **-26.75 pts** vs. previous RTH close (7756.00).

- Trading BELOW Overnight Low (7731.25)
